...
// Import images (make sure these files exist in src/assets/images/tools/ and backgrounds/)
...
import motherboardMountImage from '../assets/images/tools/motherboard-mounts.webp';
import drivesImage from '../assets/images/tools/drives.webp';
import coolerImage from '../assets/images/tools/cooler.webp';
...
const ToolsPage = () => {
  ...
  const hardwareItems = [
    ...
    {
      image: motherboardMountImage, // motherboard-mounts.webp 
